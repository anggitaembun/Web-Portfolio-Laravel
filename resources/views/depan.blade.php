...
<html lang="en">
  <head>
    ...
    <title>Freelancer - Start Boostrap</title>
    <!-- Favicon-->
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="#page-top">Website Portfolio</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <p class="lead mb-0">
            <p>Ini adalah Website Portfolio Sederhana
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container"><small> &copy; Your Website</small></div>
    </div>
    <!-- Partner Modals-->
    @php
    $i=1;
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  {!! $item->content!!}
                  <div class="-5">
                    link: <a href="{{$item->link}}" target=blank>{{$item->link}}
